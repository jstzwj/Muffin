...
Mermaid 11.16.0 registers 38 IDs. Muffin currently implements 26 IDs as 23
logical families:
...
Sankey and Treemap are complete. Implement `wardley` and `cynefin`. Port their
