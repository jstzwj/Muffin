...
int main(int argc, char** argv) {
  ...
  require(QCryptographicHash::hash(bytes, QCryptographicHash::Sha256).toHex() ==
              QByteArrayLiteral("03896858948350dfbf4d2b9ce72cc7eb16f79103e505694f3d33ad87d7d0ed47"),
          QStringLiteral("TreeView pixel manifest bytes changed"));
  const QJsonObject root = QJsonDocument::fromJson(bytes).object();
  require(root.value(QStringLiteral("fixtureSha256")).toString() ==
              QLatin1String("f1ad85d187c5871854bdc933fbf6a28261985488f30c67c5e921af9dd223d2ea"),
  ...
  for (const QJsonValue& value : cases) {
    ...
    const qreal minimumIou =
        id == QLatin1String("built-in-icons") ? 0.45 : 0.70;
    require(iou >= minimumIou, id + QStringLiteral("/alpha IoU"));
    require(rgba >= 0.76, id + QStringLiteral("/foreground RGBA"));
  }
  return 0;
}
