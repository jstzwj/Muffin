...
Theme::Theme() {
    ...
    m_name = "Github";
    m_bodyFont = QFont("Open Sans");
    m_bodyFont.setStyleHint(QFont::SansSerif);
    m_bodyFont.setPointSizeF(11.0);
    m_headingFont = QFont("Open Sans");
    m_headingFont.setStyleHint(QFont::SansSerif);
    m_headingFont.setPointSizeF(11.0);
    m_headingFont.setWeight(QFont::Bold);
    m_codeFont = QFont("Consolas");
    m_codeFont.setStyleHint(QFont::Monospace);
    m_codeFont.setPointSizeF(10.0);
    m_bodyFontSize = 16.0;
    ...
    m_linkColor = "#4183c4";
    m_metaColor = "#9aa0a6";
    m_headingColor = "#333333";
    m_headingBorderColor = "#eeeeee";
    m_headingSize[0] = 2.0;
    m_headingSize[1] = 1.5;
    ...
    m_codeBackground = "#f7f7f7";
    m_codeForeground = "#333333";
    m_quoteBorderColor = "#dddddd";
    m_quoteForeground = "#777777";
    m_tableBorderColor = "#dddddd";
    m_tableHeaderBackground = "#f7f7f7";
    m_tableAltRowBackground = "#f8f8f8";
    m_hrColor = "#eeeeee";
...
Theme Theme::preset(int index) {
    ...
    case 1: // Newsprint
        ...
        t.m_tableAltRowBackground = "#f5eddf";
        t.m_hrColor = "#e2d7c5";
    ...
    case 2: // Night
        ...
        t.m_tableAltRowBackground = "#262c31";
        t.m_hrColor = "#444c56";
    ...
    case 3: // Pixyll
        ...
        t.m_tableAltRowBackground = "#fbfbfb";
        t.m_hrColor = "#dddddd";
    ...
    case 4: // Whitey
        ...
        t.m_tableAltRowBackground = "#fafafa";
        t.m_hrColor = "#eeeeee";
