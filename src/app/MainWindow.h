...
private:
  ...
  // PNG twin of exportMermaidDiagram: same fence lookup, file dialog, and
  // status-bar confirmation; rasterizes at 2x for crispness (the same DPR the
  // HTML export embeds).
  void exportMermaidDiagramPng(NodeId blockId);
