...
std::unique_ptr<MathLayoutNode> layoutFromRenderNode(std::unique_ptr<MathRenderNode> node) {
  ...
  layout->arrayEnvironment = std::move(node->arrayEnvironment);
  layout->arrayColumnSeparation = std::move(node->arrayColumnSeparation);
  layout->arrayLeftDelimiter = std::move(node->arrayLeftDelimiter);
  layout->arrayRightDelimiter = std::move(node->arrayRightDelimiter);
  layout->arrayStretch = node->arrayStretch;
...
std::unique_ptr<MathRenderNode> renderNodeFromLayout(const MathLayoutNode& node) {
  ...
  render->arrayEnvironment = node.arrayEnvironment;
  render->arrayColumnSeparation = node.arrayColumnSeparation;
  render->arrayLeftDelimiter = node.arrayLeftDelimiter;
  render->arrayRightDelimiter = node.arrayRightDelimiter;
  render->arrayStretch = node.arrayStretch;
