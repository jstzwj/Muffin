...
QHash<QString, MathFunctionSpec> makeFunctions() {
  ...
  add(functions, spec(QStringLiteral("genfrac"),
                      names({"\\cfrac", "\\frac", "\\dfrac", "\\tfrac", "\\binom", "\\dbinom", "\\tbinom"}),
                      2,
                      Handler::Fraction,
                      Builder::Fraction,
  ...
  add(functions, spec(QStringLiteral("horizBrace"),
                      ...
                      {Arg::Original}));
  add(functions, spec(QStringLiteral("xArrow"),
                      names({"\\xleftarrow", "\\xrightarrow", "\\xLeftarrow", "\\xRightarrow",
                             "\\xleftrightarrow", "\\xLeftrightarrow", "\\xhookleftarrow", "\\xhookrightarrow",
                             "\\xmapsto", "\\xrightharpoondown", "\\xrightharpoonup", "\\xleftharpoondown",
                             "\\xleftharpoonup", "\\xrightleftharpoons", "\\xleftrightharpoons", "\\xlongequal",
  ...
  add(functions, spec(QStringLiteral("phantom"),
                      names({"\\phantom", "\\hphantom", "\\vphantom", "\\pmb"}),
                      1,
                      Handler::Phantom,
                      Builder::Phantom,
  ...
  add(functions, spec(QStringLiteral("text"),
                      names({"\\text", "\\textrm", "\\textnormal", "\\textbf", "\\textit", "\\textup", "\\textsf", "\\texttt", "\\hbox", "\\html@mathml", "\\@char"}),
                      1,
                      Handler::Text,
                      Builder::Text,
                      MathNodeType::Text,
  ...
  add(functions, spec(QStringLiteral("font"),
                      names({"\\mathrm", "\\mathbf", "\\mathit", "\\mathnormal", "\\mathsf", "\\mathtt", "\\mathbb", "\\mathcal",
                             "\\mathfrak", "\\mathscr", "\\mathsfit", "\\Bbb", "\\bold", "\\frak"}),
                      1,
                      Handler::Text,
                      Builder::Text,
                      MathNodeType::Text,
  ...
  add(functions, spec(QStringLiteral("leftright"),
                      ...
                      false,
                      true));
  add(functions, spec(QStringLiteral("middle"),
                      names({"\\middle"}),
                      1,
                      Handler::DelimSizing,
                      Builder::DelimSizing,
