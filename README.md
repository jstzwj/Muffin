...
- [x] Add native Mermaid flowchart, sequence, class, state, ER, requirement, pie, quadrant, journey, radar, XY, timeline, packet, Kanban, mindmap, TreeView, Event Modeling, Ishikawa, Venn, Sankey, Treemap, Gantt, and Info diagrams.
