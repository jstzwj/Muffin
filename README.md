...
- [x] Add native Mermaid flowchart, sequence, class, state, ER, requirement, pie, quadrant, journey, radar, XY, timeline, packet, Kanban, mindmap, Block, TreeView, Event Modeling, Ishikawa, Venn, Sankey, Treemap, Cynefin, Gantt, and Info diagrams.
