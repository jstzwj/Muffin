...
<context>
    ...
    <message>
        ...
        <translation>Markdown の変更はこのダイアログを閉じたときに反映されます（再起動は不要です）。グレー表示のオプションはまだ実装されていません。厳格モードでは、プレーンな CommonMark 出力のために表、取り消し線、タスクリスト、自動リンク、数式が無効になります。</translation>
    </message>
    <message>
